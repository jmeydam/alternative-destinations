...
def index():
    ...
    if form.validate_on_submit():
        #print(dir(form))
        #{'iata_code': 'TLV', 'date': datetime.date(2019, 1, 19), 'min_temperature_celsius': 5, 'max_temperature_celsius': 20, 'max_precipitation_mm': 0, 'submit': True, 'csrf_token': 'IjJlZmJmNWEwYWIyYzg5NzAyYjIxZTg5ZDUwNGQyZmJlNzA4MmU4NTUi.XEMG8w.FUeSxALCJ4uoF-Bf_ppIC5vJ34w'}
        #print(form.data)
